...
export const metadata: Metadata = {
  ...
  description:
    "LearnWealthX – Master in-demand skills with expert-led online courses. Start learning today and unlock your potential. Curated courses for career growth.",
  keywords: [
    "LearnWealthX",
    "learnwealthx",
    "learnwealthx.in",
