        ...
        <main className="app-main">
          <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="app-card app-card-padding space-y-6">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-ink-50">
                  Invalid Reset Link
                </h1>
          ...
          <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="app-card app-card-padding space-y-6">
              <div className="text-center">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-ink-50 mb-2">
                ...
                <p className="text-sm text-gray-500 dark:text-ink-300 mt-4">
