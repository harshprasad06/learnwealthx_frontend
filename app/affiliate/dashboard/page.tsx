      ...
      <div className="min-h-screen bg-gray-50 dark:bg-ink-950 transition-colors">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-gray-700 dark:text-ink-200 mb-4">
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-ink-950 dark:to-mint-950/40 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-600 dark:from-mint-800 to-indigo-600 dark:to-mint-950 rounded-full mb-4 shadow-lg">
          ...
          {(kycStatus === 'not_submitted' || kycStatus === 'rejected') && (
            <div className="bg-white dark:bg-ink-900 rounded-xl shadow-xl dark:shadow-black/40 border border-gray-200 dark:border-ink-800 overflow-hidden transition-colors">
              {/* Form Header */}
              <div className="bg-gradient-to-r from-blue-600 dark:from-mint-800 to-indigo-600 dark:to-mint-950 px-8 py-6">
                <h2 className="text-2xl font-bold text-white mb-2">Complete Your Verification</h2>
                <p className="text-blue-100 dark:text-mint-100 text-sm">
                ...
                <form onSubmit={handleKycSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                      <div>
                        ...
                        <select
                          name="documentType"
                          required
                          className="w-full px-4 py-3 border-2 border-gray-300 dark:border-ink-700 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-mint-500 focus:border-blue-500 dark:focus:border-mint-400 transition text-sm text-gray-900 dark:text-ink-50 bg-white dark:bg-ink-800"
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-gray-300 dark:border-ink-700 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-mint-500 focus:border-blue-500 dark:focus:border-mint-400 transition text-sm text-gray-900 dark:text-ink-50 bg-white dark:bg-ink-800 placeholder:text-gray-400 dark:placeholder:text-ink-400"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 dark:text-ink-200 mb-2">
                  ...
                  <div>
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-ink-50">Upload Documents</h3>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-ink-300 mb-6 ml-13">Upload clear, readable images or PDFs. Maximum file size: 5MB</p>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            required
                            className="block w-full text-sm text-gray-500 dark:text-ink-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-mint-900/20 file:text-blue-700 dark:file:text-mint-400 hover:file:bg-blue-100 dark:hover:file:bg-mint-900/30 file:cursor-pointer border-2 border-gray-300 dark:border-ink-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 dark:focus:ring-mint-500 focus:border-blue-500 dark:focus:border-mint-400 transition"
                          />
                        </div>
                        <p className="text-xs text-gray-500 dark:text-ink-400 mt-1">JPEG, PNG, or PDF</p>
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 dark:text-ink-200 mb-2">
                        ...
                        <div className="relative">
                          <input
                            ...
                            type="file"
                            accept=".jpg,.jpeg,.png,.pdf"
                            className="block w-full text-sm text-gray-500 dark:text-ink-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-gray-50 dark:file:bg-ink-900 file:text-gray-700 dark:file:text-ink-200 hover:file:bg-gray-100 dark:hover:file:bg-ink-800 file:cursor-pointer border-2 border-gray-300 dark:border-ink-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 dark:focus:ring-mint-500 focus:border-blue-500 dark:focus:border-mint-400 transition"
                          />
                        </div>
                        <p className="text-xs text-gray-500 dark:text-ink-400 mt-1">JPEG, PNG, or PDF</p>
                      </div>
                  ...
                  {/* Submit Button */}
                  <div className="pt-6 border-t border-gray-200 dark:border-ink-800 flex justify-end">
                    <button
                      type="submit"
                      disabled={kycLoading}
                      className="px-8 py-3 bg-gradient-to-r from-blue-600 dark:from-mint-800 to-indigo-600 dark:to-mint-950 text-white font-semibold rounded-lg shadow-lg hover:from-blue-700 dark:hover:from-mint-700 hover:to-indigo-700 dark:hover:to-mint-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 flex items-center space-x-2"
                    >
                      {kycLoading ? (
                        <>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-ink-950 transition-colors">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-blue-500 dark:from-mint-800 to-indigo-600 dark:to-mint-950 rounded-lg shadow-lg p-4 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link
            href="/affiliate/wallet"
            className="bg-gradient-to-r from-blue-600 dark:from-mint-800 to-indigo-600 dark:to-mint-950 rounded-lg shadow-lg px-4 py-5 text-white hover:from-blue-700 dark:hover:from-mint-700 hover:to-indigo-700 dark:hover:to-mint-900 transition-all transform hover:scale-105"
          >
          ...
          <Link
            ...
            className="bg-gradient-to-r from-purple-600 dark:from-mint-900 to-pink-600 dark:to-mint-800 rounded-lg shadow-lg px-4 py-5 text-white hover:from-purple-700 dark:hover:from-mint-800 hover:to-pink-700 dark:hover:to-mint-700 transition-all transform hover:scale-105"
          >
            <div className="flex items-center justify-between">
              <div>
            ...
            <>
              ...
              <div className="mb-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 dark:bg-mint-500 text-white dark:text-ink-950 text-sm font-medium rounded-md hover:bg-blue-700 dark:hover:bg-mint-400"
                >
