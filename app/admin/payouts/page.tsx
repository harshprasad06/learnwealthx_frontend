                    ...
                    {payouts.map((payout) => (
                      <tr key={payout.id} className="hover:bg-gray-50 dark:hover:bg-ink-900">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-500 dark:text-ink-400">
                          ...
                          <br />
                          <span className="text-xs text-gray-400 dark:text-ink-300">
                            ...
                            {(() => {
                              try {
                                ...
                                if (details.autoGenerated) {
                                  return (
                                    <span className="px-2 py-1 text-xs bg-purple-100 dark:bg-mint-900/30 text-purple-700 dark:text-mint-300 rounded font-medium">
                                      Auto
                                    </span>
                                  );
                                }
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className="text-gray-400 dark:text-ink-300 hover:text-gray-600 dark:hover:text-ink-300"
                  >
                    ✕
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  {selectedPayout.failureReason && (
                    <div className="border-b pb-4">
                      <h3 className="text-lg font-semibold mb-3 text-red-600 dark:text-red-400">Failure Reason</h3>
                        ...
                        {processStatus === 'failed' && (
                          <div>
                            ...
                            <textarea
                              ...
                              rows={3}
                              required
                              className="w-full px-3 py-2 border border-gray-300 dark:border-ink-700 rounded-md text-gray-900 dark:text-ink-50 placeholder:text-gray-400 dark:placeholder:text-ink-400"
                            />
                          </div>
                        )}
