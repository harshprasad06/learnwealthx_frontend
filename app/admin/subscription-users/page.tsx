        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Total Subscribers</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-ink-50">{data.total}</p>
            </div>
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Total Subscriptions</p>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-ink-800">
                  ...
                  <tbody className="bg-white dark:bg-ink-900 divide-y divide-gray-200 dark:divide-ink-800">
                    {data.subscribers.map((subscriber) => {
                      ...
                      return (
                        <tr key={subscriber.affiliateId} className="hover:bg-gray-50 dark:hover:bg-ink-800 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                ...
                                <div className="text-sm text-gray-500 dark:text-ink-300">{subscriber.email}</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
