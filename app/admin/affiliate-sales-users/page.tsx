        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Total Buyers</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-ink-50">{data.total}</p>
            </div>
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Total Purchases</p>
              <p className="text-2xl font-bold text-green-600 dark:text-green-400">
                {data.buyers.reduce((sum, buyer) => sum + buyer.purchaseCount, 0)}
              </p>
            </div>
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Platform Earnings</p>
            ...
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Affiliate Earnings</p>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-ink-800">
                  ...
                  <tbody className="bg-white dark:bg-ink-900 divide-y divide-gray-200 dark:divide-ink-800">
                    {data.buyers.map((buyer) => {
                      ...
                      return (
                        <>
                          <tr key={buyer.userId} className="hover:bg-gray-50 dark:hover:bg-ink-800 transition-colors">
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                  ...
                                  <div className="text-sm text-gray-500 dark:text-ink-300">{buyer.email}</div>
                                </div>
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm font-semibold text-blue-600 dark:text-mint-400">
                                  ...
                                  <div className="space-y-2">
                                    {buyer.purchases.map((purchase, idx) => (
                                      ...
                                      >
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mt-3 pt-3 border-t border-gray-200 dark:border-ink-700">
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-ink-300">Platform Share</p>
                                            <p className="text-sm font-semibold text-blue-600 dark:text-mint-400">
                                              ₹{purchase.platformShare.toFixed(2)} ({(data.platformShareRate * 100).toFixed(0)}%)
                                            </p>
                                          </div>
                                          <div>
                                            <p className="text-xs text-gray-500 dark:text-ink-300">Affiliate Commission</p>
