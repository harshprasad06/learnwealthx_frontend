...
const Avatar = ({ imageUrl, name, email }: { imageUrl: string | null; name: string | null; email: string }) => {
  ...
  if (!imageUrl || imageError) {
    return (
      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 dark:from-mint-800 to-indigo-600 dark:to-mint-950 flex items-center justify-center text-white font-semibold text-sm shadow-sm">
        {initial}
      </div>
    );
  }
      ...
      <main className="app-main">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="app-card app-card-padding">
              <p className="text-sm font-medium text-gray-500 dark:text-ink-300 mb-1">Total Revenue</p>
                          ...
                          <tr key={buyer.userId} className="hover:bg-gray-50 dark:hover:bg-ink-800 transition-colors">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <button
                                ...
                                className="text-sm text-blue-600 dark:text-mint-400 hover:text-blue-700 dark:hover:text-mint-300 font-medium transition-colors"
                              >
                                  ...
                                  <div className="space-y-2">
                                    {buyer.purchases.map((purchase, idx) => (
                                      <div
                                        ...
                                        className="flex items-center justify-between p-3 bg-white dark:bg-ink-900 rounded-md border border-gray-200 dark:border-ink-700"
                                      >
